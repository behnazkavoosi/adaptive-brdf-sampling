...
if(strcmp(method,'kmeans'))
    ...
    save(strcat('BRDF_clusters_kmeans_', num2str(k), '_', num2str(iteration), '.mat'), 'result', 'centroid', '-v7.3');
...
elseif(strcmp(method,'kmeans++') || strcmp(method,'kmeanspp')) 
    ...
    save(strcat('BRDF_clusters_kmeanspp_', num2str(k), '_', num2str(iteration), '.mat'), 'result', 'centroid', '-v7.3');
...
elseif(strcmp(method,'ISODATA') || strcmp(method,'isodata'))
    ...
    save(strcat('BRDF_clusters_ISODATA_', num2str(desired_k), '_', num2str(iteration), '_', num2str(minimum_n) ...
        , '_', num2str(maximum_variance), '_', num2str(minimum_d), '.mat'), 'result', 'centroid', '-v7.3');
...
%     save(strcat('BRDF_clusters_meanshift_', thr, '.mat'), 'result', 'centroid', '-v7.3');
...
elseif(strcmp(method,'dbscan') || strcmp(method,'DBSCAN'))
    ...
    save(strcat('BRDF_clusters_DBSCAN_', num2str(epsilon), '_', num2str(minPts), '.mat'), 'result', 'centroid', '-v7.3');
...
elseif(strcmp(method,'GMM') || strcmp(method,'gmm'))
    ...
    save(strcat('BRDF_clusters_GMM_', num2str(k), '_', num2str(iter), '.mat'), 'result', 'centroid', '-v7.3');
...
elseif(strcmp(method,'LVQ') || strcmp(method,'lvq'))
    ...
    save(strcat('BRDF_clusters_LVQ_', num2str(q), '_', num2str(neta), '_', num2str(iter), '.mat'), 'result', 'centroid', '-v7.3');
